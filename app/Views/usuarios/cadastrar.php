...
<form name="cadastrar" action="<?=URL?>/usuarios/cadastrar" method="post">
    <fieldset class="fieldset_criar_conta">
        ...
        <div>
            ...
            <div style="margin-left: 7px; display: flex; align-items: center; color: rgb(202, 202, 202);"><span
                    style="margin-right: 2px;">Titulo:</span><input type="radio" name="titulo" id="" value="Sr.">Sr.
                <input type="radio" style="margin-left: 2px;" name="titulo" id="" value="Sra.">Sra. <small class="erro">
                    <?= $dados['titulo_erro']?></small>
            </div>
            <div>
            ...
            <div>
                ...
                <input class="input_increver-se" type="text" name="senha" id="senha" placeholder="Senha:">
            ...
            <div>
                ...
                <input class="input_increver-se" type="text" name="confirmar_senha" id=""
                    placeholder="Confirmar senha:"> <small class="erro"> <?= $dados['confirmar_senha_erro']?></small>
            </div>
