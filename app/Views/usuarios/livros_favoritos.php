...
<section class="section_info_itens_no_carrinho1">
  <div class="div_capa_livro" style="height: 70px; width: 70px;"><img  src="<?= URL ?>/public/uploads/capa/<?= $LF->url_capa ?>"  alt=""></div> <div  class="info_itens_carrinho2"><span>Titulo: <?= $LF->titulo ?></span> <span>Categoria: <?= $LF->categoriaNome ?></span> <span>Autor: <?= $LF->autorNome ?></span> <span>Preço: <?= number_format($LF->preco, 0,',','.') ?> USD</span> </div> <DIV> 
